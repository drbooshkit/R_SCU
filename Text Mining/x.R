...
news_sites <- c("http://xhamster.com")
...
# remove specific words you don't want
#txtCLEAN <- txtCLEAN[setdiff(seq(1,n),grep("the",txtCLEAN))]
#txtCLEAN <- txtCLEAN[setdiff(seq(1,n),grep("his",txtCLEAN))]
#txtCLEAN <- txtCLEAN[setdiff(seq(1,n),grep("and",txtCLEAN))]
#txtCLEAN <- txtCLEAN[setdiff(seq(1,n),grep("she",txtCLEAN))]
#txtCLEAN <- txtCLEAN[setdiff(seq(1,n),grep("her",txtCLEAN))]
#txtCLEAN <- txtCLEAN[setdiff(seq(1,n),grep("he",txtCLEAN))]
#txtCLEAN <- txtCLEAN[setdiff(seq(1,n),grep("<div>",txtCLEAN))]
#txtCLEAN <- txtCLEAN[setdiff(seq(1,n),grep("</div>",txtCLEAN))]

# what are the most common words?
#findFreqTerms(wordcount,lowfreq=2)
