...
news_sites <- c("http://fulltextrssfeed.com/www.npr.org/rss/rss.php?id=1001", "http://www.wsj.com", "http://news.google.com/news",
   "http://www.c-span.org/", "http://fulltextrssfeed.com/rss.nytimes.com/services/xml/rss/nyt/HomePage.xml",  "http://fulltextrssfeed.com/feeds.reuters.com/Reuters/domesticNews", 
...
print(news_sites[i])
print(c(avgSent[i], "average sentiment (-5,+5)"))
